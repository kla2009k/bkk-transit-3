    ...
    story.extend(
        [
            ...
            Table(
                [
                    [
                        img("mrta_camp/tabs-expanded-desktop.png", 96),
                        img("mrta_camp/ai-mobility-lab-mobile.png", 48),
                    ],
                    [
                        p("Desktop: หน้า tab และข้อมูลบริการแบบเต็มจอ", "ThaiSmall"),
                        p("มือถือ: AI Mobility Lab / crowd prediction roadmap", "ThaiSmall"),
                    ],
                ],
                colWidths=[103 * mm, 52 * mm],
                style=TableStyle(
                    [
                        ("VALIGN", (0, 0), (-1, -1), "TOP"),
                        ("ALIGN", (0, 0), (-1, -1), "CENTER"),
