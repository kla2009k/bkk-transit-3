        ...
        [
            ...
            feature_table(
                [
                    ...
                    ("Transit AI Copilot", "prototype ผู้ช่วยถาม-ตอบสำหรับผู้โดยสารใหม่ ใช้ local/rule content ก่อน และต่อ LLM ผ่าน backend ได้ในอนาคตโดยไม่ฝัง API key ในเว็บ"),
        ...
        [
            section(
                ...
                [
                    ...
                    "เพิ่ม Transit AI Copilot ผ่าน backend ที่ควบคุม privacy/logging ได้ ไม่ฝัง API key หรือเรียก LLM ตรงจากหน้าเว็บ public",
            ...
            section(
                ...
                [
                    ...
                    "AI Copilot ควรตอบจากข้อมูลทางการอย่างไร และควรป้องกัน hallucination/คำแนะนำผิดพลาดด้วย policy ใด",
