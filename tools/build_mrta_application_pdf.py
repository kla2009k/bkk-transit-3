...
def build():
    ...
    story.extend(
        [
            ...
            section(
                "สถานการณ์ตัวอย่างของผู้ใช้",
                "นักเรียนต่างจังหวัดต้องเดินทางจากสถานีใกล้ที่พักไปศูนย์ประชุมหรือโรงพยาบาลในกรุงเทพฯ เป็นครั้งแรก เขาอาจเปิดแผนที่ทั่วไปแล้วรู้ว่าต้องไปสถานีไหน แต่ยังไม่รู้ว่าต้องซื้อตั๋วอย่างไร เปลี่ยนสายตรงไหน ใช้สิทธิ 20 บาทได้หรือไม่ รถหมดกี่โมง และเมื่อลงสถานีแล้วควรออกทางออกใด Bangkok Transit 3D จึงพยายามตอบคำถามก่อนเดินทางเหล่านี้ในที่เดียว",
            ),
            section(
                "Pain point ที่กระทบต่อการเลือกเดินทาง",
                None,
                [
                    "ก่อนเดินทาง: ไม่มั่นใจเส้นทางและค่าโดยสาร จึงลังเลว่าจะใช้รถไฟฟ้าดีหรือไม่",
                    "ระหว่างเดินทาง: กลัวเปลี่ยนสายผิดระบบหรือแตะบัตรผิด ทำให้เกิดความเครียด",
                    "หลังถึงสถานี: ไม่รู้ทางออกหรือจุดต่อรถ ทำให้ประสบการณ์ปลายทางยังไม่จบจริง",
                ],
            ),
            PageBreak(),
        ]
    ...
    story.extend(
        [
            ...
            section(
                ...
                None,
                [
                    "Confidence first: หน้าจอแรก ๆ ต้องทำให้ผู้ใช้มั่นใจ ไม่ใช่เพิ่มข้อมูลจนสับสน",
                    "Explain before optimize: ผู้โดยสารใหม่ต้องเข้าใจเหตุผลของเส้นทางก่อนค่อยดูเส้นทางที่เร็วที่สุด",
                    "No fake realtime: ข้อมูลที่ยังไม่มี feed จริงต้องระบุว่าเป็น roadmap หรือข้อมูลประมาณการ ไม่ทำเหมือนเป็นข้อมูลสด",
                    "Mobile first: กรรมการและผู้ใช้จริงควรสแกน QR แล้วทดลองบนมือถือได้ทันที",
                ],
            ),
            section(
                "สิ่งที่ prototype พิสูจน์แล้ว",
                "ผลงานปัจจุบันไม่ใช่เพียงภาพร่าง แต่เป็นเว็บแอปที่เปิดผ่าน GitHub Pages ได้จริง มีโครงสร้าง PWA, service worker, route planner, หน้าบริการ/ข่าวสาร/เพิ่มเติม และหน้าสรุปข้อมูลที่แยกแหล่งข้อมูลชัดเจน",
            ),
            PageBreak(),
        ]
    )
    ...
    story.extend(
        [
            ...
            section(
                "เหตุผลที่เลือกกลุ่มผู้ใช้เหล่านี้ก่อน",
                None,
                [
                    "เป็นกลุ่มที่มีความต้องการเดินทางจริง แต่ขาดความคุ้นเคยกับระบบรางเมืองใหญ่",
                    "หากช่วยให้กลุ่มนี้เข้าใจได้ ผู้ใช้ทั่วไปก็จะใช้งานได้ง่ายขึ้นด้วย",
                    "เป็นกลุ่มที่สอดคล้องกับภารกิจสาธารณะของระบบราง คือทำให้เมืองเข้าถึงได้ ไม่ใช่สะดวกเฉพาะคนที่คุ้นเคยอยู่แล้ว",
                    "สามารถทดสอบกับผู้ใช้จริงได้จากเพื่อน นักเรียน ผู้ปกครอง และคนต่างจังหวัดที่เข้ากรุงเทพฯ",
                ],
            ),
            PageBreak(),
        ]
        ...
        [
            ...
            feature_table(
                [
                    ...
                    ("AI Mobility Lab", "แสดง roadmap สำหรับ crowd prediction, smart accessibility, IoT safety และ energy saving โดยระบุชัดว่าเป็น concept ที่ต้องใช้ข้อมูลทางการในอนาคต"),
                    ("Transit AI Copilot", "ผู้ช่วยถาม-ตอบที่ต่อ Gemini API ได้จริงแบบใส่ API key ในเครื่องผู้ใช้ และวางแนวทาง production ให้ต่อผ่าน backend เพื่อคุม quota/privacy"),
                    ("Route Goals / POI / Safety", "วาง roadmap สำหรับเลือกเส้นทางตามเป้าหมาย ค้นปลายทางสำคัญ และคู่มือเหตุฉุกเฉินสำหรับผู้ใช้ครั้งแรก"),
                ]
            ),
            Spacer(1, 6 * mm),
            section(
                "Demo flow ที่กรรมการควรลอง",
                None,
                [
                    "สแกน QR เปิดเว็บบนมือถือ แล้วทดลอง Add to Home Screen เพื่อเห็นศักยภาพแบบแอป",
                    "เปิด Demo Mode เพื่อดูเส้นทางตัวอย่างและการนำทางแบบรวดเร็ว",
                    "เข้า บริการ -> เทียบราคา 20 บาท vs ปกติ เพื่อดูว่าข้อมูลนโยบายถูกแปลเป็นประโยชน์ต่อทริปจริง",
                    "เข้า บริการ -> ซ้อมนั่งครั้งแรก เพื่อดูแนวคิด pre-trip simulator สำหรับผู้โดยสารใหม่",
                    "เข้า เพิ่มเติม -> ที่มาข้อมูล เพื่อดูความโปร่งใสว่าอะไรคือข้อมูลจริง อะไรคือข้อมูลประมาณการ และอะไรเป็นแผนต่อยอด",
                ],
            ),
            PageBreak(),
        ]
    ...
    story.extend(
        [
            ...
            section(
                "ความเชื่อมโยงกับบทบาทของ MRTA",
                None,
                [
                    "ช่วยสื่อสารบทบาทของสาย MRT และสายที่เกี่ยวข้องกับ รฟม. ในโครงข่ายระบบรางทั้งเมือง",
                    "ช่วยทำให้ข้อมูลนโยบาย เช่น 20 บาทตลอดสาย เข้าใจผ่านเส้นทางจริงของผู้ใช้",
                    "เป็นต้นแบบช่องทาง pre-trip information ที่สามารถเชื่อมกับข้อมูลทางการในอนาคต",
                    "สนับสนุนภาพลักษณ์ของ MRTA ในฐานะหน่วยงานที่ไม่เพียงสร้างโครงสร้างพื้นฐาน แต่ยกระดับประสบการณ์ผู้โดยสาร",
                ],
            ),
            PageBreak(),
        ]
    ...
    story.extend(
        [
            ...
            Table(
                [
                    [
                        img("mrta_camp/tabs-expanded-desktop.png", 78),
                        img("mrta_camp/ai-mobility-lab-mobile.png", 38),
                        img("mrta_camp/transit-copilot-mobile.png", 38),
                    ],
                    [
                        p("Desktop: หน้า tab และข้อมูลบริการ", "ThaiSmall"),
                        p("AI Mobility Lab", "ThaiSmall"),
                        p("Transit AI Copilot", "ThaiSmall"),
                    ],
                ],
                colWidths=[82 * mm, 38 * mm, 38 * mm],
                style=TableStyle(
                    [
                        ("VALIGN", (0, 0), (-1, -1), "TOP"),
                        ("ALIGN", (0, 0), (-1, -1), "CENTER"),
        ...
        [
            section(
                ...
                [
                    ...
                    "พัฒนา AI crowd prediction จากข้อมูลนิรนาม เช่น tap-in/tap-out รายเวลา event สภาพอากาศ จุดเปลี่ยนสาย และสถานะเดินรถ",
                    "ยกระดับ Transit AI Copilot จาก BYO Gemini API key ใน prototype ไปเป็น backend/serverless proxy ที่ควบคุม privacy, quota, logging และ safety policy ได้",
                    "พัฒนา route goals เช่น เร็วที่สุด คนน้อยที่สุด เดินน้อยที่สุด เหมาะกับ wheelchair และถูกที่สุด",
                    "ทดสอบ UX กับผู้ใช้จริงจากต่างจังหวัด แล้วปรับ flow ภาษา ปุ่ม และคำอธิบายให้เข้าใจง่ายขึ้น",
                ],
            ),
            section(
                "ลำดับการพัฒนาหลังเข้าค่าย",
                "ระยะสั้น: เก็บ feedback และปรับ UX<br/>ระยะกลาง: เชื่อมข้อมูลทางการและทำ accessibility route<br/>ระยะยาว: พัฒนาเป็น AI Mobility Assistant ที่คาดการณ์ความหนาแน่น แนะนำ route ที่เหมาะกับผู้ใช้แต่ละกลุ่ม และช่วย operator บริหารสถานี",
            ),
            section(
                "สิ่งที่ต้องการ validate ในค่าย",
                None,
                [
                    "ผู้โดยสารใหม่เข้าใจเส้นทางได้เร็วขึ้นจริงหรือไม่หลังใช้ prototype",
                    "คำอธิบายเรื่องบัตร ค่าโดยสาร และการเปลี่ยนสายชัดพอสำหรับคนที่ไม่เคยขึ้นรถไฟฟ้าหรือไม่",
                    "ข้อมูลประเภทใดควรมาจาก MRTA/ผู้ให้บริการเท่านั้น เพื่อรักษาความถูกต้อง",
                    "โมเดล crowd prediction ควรแสดงผลเป็นตัวเลข ความหนาแน่นระดับสี หรือคำแนะนำเวลาเดินทางแบบใดจึงจะเข้าใจง่ายที่สุด",
                    "AI Copilot ควรตอบจากข้อมูลทางการอย่างไร ควรจำกัดคำตอบด้าน real-time/incident อย่างไร และควรป้องกัน hallucination ด้วย policy ใด",
                    "รูปแบบใดเหมาะกว่าในอนาคต: เป็น service ของหน่วยงาน, embedded page, หรือ public data assistant",
                ],
            ),
            PageBreak(),
        ]
    ...
    story.extend(
        [
            ...
            section(
                "ผลกระทบต่อเมืองในระยะยาว",
                "หากผู้โดยสารใหม่จำนวนมากขึ้นกล้าใช้ระบบรางตั้งแต่ทริปแรก เมืองจะได้ประโยชน์มากกว่าการลดความสับสนรายบุคคล เพราะทุกทริปที่ย้ายจากรถส่วนตัวหรือแท็กซี่มาสู่ระบบรางช่วยลดภาระถนน ลดมลพิษ และเพิ่มคุณค่าของโครงสร้างพื้นฐานที่รัฐลงทุนไว้แล้ว",
            ),
            PageBreak(),
        ]
    )
    ...
    story.extend(
        [
            ...
            section(
                ...
                None,
                [
                    "ความเสี่ยงด้านข้อมูลเก่า: ใช้วิธีระบุแหล่งที่มาและวันที่อัปเดต พร้อมแยกข้อมูลประมาณการออกจากข้อมูลทางการ",
                    "ความเสี่ยงด้านความเข้าใจผิดว่าเป็นแอปทางการ: ระบุชัดว่าเป็น prototype นักเรียน และควรต่อยอดกับข้อมูล MRTA จริงในอนาคต",
                    "ความเสี่ยงด้านการใช้งานบนมือถือหลายรุ่น: เลือกแนวทางเว็บแอป/PWA เพื่อลดข้อจำกัดการติดตั้งและทดสอบผ่าน browser มาตรฐาน",
                ],
            ),
        ]
    )
